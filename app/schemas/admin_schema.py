...
class TallerCreadoResponse(TallerAdminResponse):
    """
    Respuesta al registrar un taller desde el admin.
    Incluye el tenant + slug recien creados (el slug ES el subdominio del taller).
    El frontend arma la URL: https://{slug}.{dominio-actual}
    """
    id_tenant: int
    slug: str
